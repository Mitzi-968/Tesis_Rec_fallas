...
#include "nesl_rtw.h"
#include "CtrlP_Tray_Poli_ROS_99de2b7c_1.h"
#include "CtrlP_Tray_Poli_ROS_99de2b7c_1_gateway.h"

void CtrlP_Tray_Poli_ROS_99de2b7c_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0.002, 0, 0, 0,
    0, (SscLoggingSetting) 0, 522251032, };
  ...
  CtrlP_Tray_Poli_ROS_99de2b7c_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "CtrlP_Tray_Poli_ROS/Dinamica/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
