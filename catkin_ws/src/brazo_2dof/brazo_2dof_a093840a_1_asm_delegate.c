...
void brazo_2dof_a093840a_1_setTargets(const RuntimeDerivedValuesBundle *rtdv,
  CTarget *targets)
{
  (void) rtdv;
  (void) targets;
...
void brazo_2dof_a093840a_1_resetAsmStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void brazo_2dof_a093840a_1_initializeTrackedAngleState(const void *mech, const
...
void brazo_2dof_a093840a_1_computeDiscreteState(const void *mech, const
...
void brazo_2dof_a093840a_1_adjustPosition(const void *mech, const double
...
void brazo_2dof_a093840a_1_perturbAsmJointPrimitiveState(const void *mech,
...
void brazo_2dof_a093840a_1_computeDofBlendMatrix(const void *mech, size_t
...
void brazo_2dof_a093840a_1_projectPartiallyTargetedPos(const void *mech, size_t
...
void brazo_2dof_a093840a_1_propagateMotion(const void *mech, const
...
size_t brazo_2dof_a093840a_1_computeAssemblyError(const void *mech, const
...
size_t brazo_2dof_a093840a_1_computeAssemblyJacobian(const void *mech, const
...
size_t brazo_2dof_a093840a_1_computeFullAssemblyJacobian(const void *mech, const
...
int brazo_2dof_a093840a_1_isInKinematicSingularity(const void *mech, const
...
PmfMessageId brazo_2dof_a093840a_1_convertStateVector(const void *asmMech, const
