...
//
// File: CtrlP_Tray_Poli_ROS_data.cpp
//
...
P_CtrlP_Tray_Poli_ROS_T CtrlP_Tray_Poli_ROS_P = {
  ...
  { 1.57, 0.0, 0.75, -0.75, 0.0, -1.57, -0.75, -0.75, -1.57, 0.0, 0.0, 0.75 },

  // Expression: [ 0, 2,4,6,8,10]
  //  Referenced by: '<Root>/Polynomial Trajectory'
