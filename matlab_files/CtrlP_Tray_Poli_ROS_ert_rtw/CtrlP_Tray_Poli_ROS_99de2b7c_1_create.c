...
int32_T sm_ssci_logFcn_codeGen(const NeDae *dae,
  ...
  PmRealVector *output);
extern const NeAssertData CtrlP_Tray_Poli_ROS_99de2b7c_1_assertData[];
extern const NeZCData CtrlP_Tray_Poli_ROS_99de2b7c_1_ZCData[];
void CtrlP_Tray_Poli_ROS_99de2b7c_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_deriv(
...
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_outputDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_outputKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_output (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_onModeChanged(
  const double *, const double *, const double *,
  const int *,
  int *,
  double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_computeZeroCrossings(
  const double *, const double *, const double *,
  double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
...
void CtrlP_Tray_Poli_ROS_99de2b7c_1_checkTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector);

#endif

void CtrlP_Tray_Poli_ROS_99de2b7c_1_setTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  CTarget *targets);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_resetAsmStateVector(const void *mech, double
  *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_resetSimStateVector(const void *mech, double
  *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  double *stateVector,
  void *neDiagMgr);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_computeDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t CtrlP_Tray_Poli_ROS_99de2b7c_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
int CtrlP_Tray_Poli_ROS_99de2b7c_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_convertStateVector(
  const void *asmMech,
  ...
  void *neDiagMgr);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_constructStateVector(
  const void *mech,
...
void CtrlP_Tray_Poli_ROS_99de2b7c_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
int CtrlP_Tray_Poli_ROS_99de2b7c_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
int CtrlP_Tray_Poli_ROS_99de2b7c_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  double *error);
void CtrlP_Tray_Poli_ROS_99de2b7c_1_resetModeVector(const void *mech, int
  *modeVector);
PmfMessageId CtrlP_Tray_Poli_ROS_99de2b7c_1_assemble(const double *u, double
  *udot, double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  CtrlP_Tray_Poli_ROS_99de2b7c_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  CtrlP_Tray_Poli_ROS_99de2b7c_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  CtrlP_Tray_Poli_ROS_99de2b7c_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = CtrlP_Tray_Poli_ROS_99de2b7c_1_deriv(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = CtrlP_Tray_Poli_ROS_99de2b7c_1_output(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = CtrlP_Tray_Poli_ROS_99de2b7c_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 2,
    systemInput->mV.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    CtrlP_Tray_Poli_ROS_99de2b7c_1_computeZeroCrossings(
    systemInput->mU.mX,
    systemInput->mU.mX + 2,
    systemInput->mV.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL && smData->mDoCheckDynamics) {
    double result = 0.0;
    errorId = CtrlP_Tray_Poli_ROS_99de2b7c_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (modeChanged) {
    errorId = CtrlP_Tray_Poli_ROS_99de2b7c_1_onModeChanged(
      systemInput->mU.mX,
      systemInput->mU.mX + 2,
      systemInput->mV.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 2,
      systemInput->mV.mX + 2,
  ...
  CtrlP_Tray_Poli_ROS_99de2b7c_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[4] = {
    { 0, 9, 0, false, 0, 2, "rad", false, true, +1.000000000000000000e+00, true,
      1, { +1.570000000000000062e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 9, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 10, 0, false, 0, 2, "deg", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 10, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } }
  };
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = CtrlP_Tray_Poli_ROS_99de2b7c_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = CtrlP_Tray_Poli_ROS_99de2b7c_1_ZCData;
    size_t i;
  ...
  void initVariables(NeDaePrivateData *smData)
{
  const char *varFullPaths[4] = {
    "Dinamica.joint_A.Rz.q",
    "Dinamica.joint_A.Rz.w",
    "Dinamica.joint_B.Rz.q",
    "Dinamica.joint_B.Rz.w"
  };

  const char *varObjects[4] = {
    "CtrlP_Tray_Poli_ROS/Dinamica/joint_A",
    "CtrlP_Tray_Poli_ROS/Dinamica/joint_A",
    "CtrlP_Tray_Poli_ROS/Dinamica/joint_B",
    "CtrlP_Tray_Poli_ROS/Dinamica/joint_B"
  };
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mSetTargets = CtrlP_Tray_Poli_ROS_99de2b7c_1_setTargets;
  delegate->mResetStateVector =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_computeDiscreteState;
  delegate->mAdjustPosition = CtrlP_Tray_Poli_ROS_99de2b7c_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputeDofBlendMatrix =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_computeDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = CtrlP_Tray_Poli_ROS_99de2b7c_1_propagateMotion;
  delegate->mComputeAssemblyError =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_isInKinematicSingularity;
  delegate->mConvertStateVector =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_perturbFlexibleBodyState;
  ...
  delegate->mConstructStateVector =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_extractSolverStateVector;
  delegate->mIsPositionViolation =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_isPositionViolation;
  delegate->mIsVelocityViolation =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_isVelocityViolation;
  delegate->mProjectStateSim = CtrlP_Tray_Poli_ROS_99de2b7c_1_projectStateSim;
  delegate->mComputeConstraintError =
    CtrlP_Tray_Poli_ROS_99de2b7c_1_computeConstraintError;
  delegate->mResetModeVector = CtrlP_Tray_Poli_ROS_99de2b7c_1_resetModeVector;
  delegate->mMech = NULL;
}
...
void CtrlP_Tray_Poli_ROS_99de2b7c_1_NeDaePrivateData_create(NeDaePrivateData
  *smData)
{
