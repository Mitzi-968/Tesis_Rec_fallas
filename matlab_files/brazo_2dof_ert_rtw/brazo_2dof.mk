...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/brazo_2dof.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/brazo_2dof.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/brazo_2dof_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/physmod/sm/ssci/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/sm/core/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/pm_math/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/simscape/engine/sli/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/simscape/engine/core/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/simscape/compiler/core/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/network_engine/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/common/math/core/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/common/lang/core/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/common/external/library/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/physmod/common/foundation/core/c/glnxa64 -I$(MATLAB_ROOT)/toolbox/ros/slros/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
%.c.o : $(START_DIR)/brazo_2dof_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/brazo_2dof_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/brazo_2dof_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
brazo_2dof_a093840a_1.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_create.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_create.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_setParameters.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_setParameters.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_asserts.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_asserts.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_deriv.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_deriv.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_checkDynamics.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_checkDynamics.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_output.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_output.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_asm_delegate.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_asm_delegate.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_sim_delegate.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_sim_delegate.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_mode_zero_crossings.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_mode_zero_crossings.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_geometries.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_geometries.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof_a093840a_1_gateway.c.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof_a093840a_1_gateway.c
	$(CC) $(CFLAGS) -o $@ $<


pm_printf.c.o : $(START_DIR)/brazo_2dof_ert_rtw/pm_printf.c
	$(CC) $(CFLAGS) -o $@ $<


ert_main.cpp.o : $(START_DIR)/brazo_2dof_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_backsubrr_dbl.c.o : $(START_DIR)/brazo_2dof_ert_rtw/rt_backsubrr_dbl.c
	$(CC) $(CFLAGS) -o $@ $<


rt_forwardsubrr_dbl.c.o : $(START_DIR)/brazo_2dof_ert_rtw/rt_forwardsubrr_dbl.c
	$(CC) $(CFLAGS) -o $@ $<


rt_lu_real.c.o : $(START_DIR)/brazo_2dof_ert_rtw/rt_lu_real.c
	$(CC) $(CFLAGS) -o $@ $<


rt_matrixlib_dbl.c.o : $(START_DIR)/brazo_2dof_ert_rtw/rt_matrixlib_dbl.c
	$(CC) $(CFLAGS) -o $@ $<


brazo_2dof.cpp.o : $(START_DIR)/brazo_2dof_ert_rtw/brazo_2dof.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/brazo_2dof_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/brazo_2dof_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
