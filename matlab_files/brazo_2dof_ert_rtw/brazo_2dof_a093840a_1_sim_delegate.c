...
void brazo_2dof_a093840a_1_resetSimStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void brazo_2dof_a093840a_1_perturbSimJointPrimitiveState(const void *mech,
...
void brazo_2dof_a093840a_1_perturbFlexibleBodyState(const void *mech, size_t
...
void brazo_2dof_a093840a_1_constructStateVector(const void *mech, const double
...
void brazo_2dof_a093840a_1_extractSolverStateVector(const void *mech, const
...
int brazo_2dof_a093840a_1_isPositionViolation(const void *mech, const
...
int brazo_2dof_a093840a_1_isVelocityViolation(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId brazo_2dof_a093840a_1_projectStateSim(const void *mech, const
...
void brazo_2dof_a093840a_1_computeConstraintError(const void *mech, const
