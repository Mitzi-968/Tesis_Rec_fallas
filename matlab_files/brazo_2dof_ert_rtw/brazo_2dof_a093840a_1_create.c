...
int32_T sm_ssci_logFcn_codeGen(const NeDae *dae,
  ...
  PmRealVector *output);
extern const NeAssertData brazo_2dof_a093840a_1_assertData[];
extern const NeZCData brazo_2dof_a093840a_1_ZCData[];
void brazo_2dof_a093840a_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void brazo_2dof_a093840a_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void brazo_2dof_a093840a_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void brazo_2dof_a093840a_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId brazo_2dof_a093840a_1_deriv(
...
PmfMessageId brazo_2dof_a093840a_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId brazo_2dof_a093840a_1_outputDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId brazo_2dof_a093840a_1_outputKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId brazo_2dof_a093840a_1_output (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId brazo_2dof_a093840a_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId brazo_2dof_a093840a_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId brazo_2dof_a093840a_1_onModeChanged(
  const double *, const double *, const double *,
  const int *,
  int *,
  double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId brazo_2dof_a093840a_1_computeZeroCrossings(
  const double *, const double *, const double *,
  double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
...
void brazo_2dof_a093840a_1_checkTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector);

#endif

void brazo_2dof_a093840a_1_setTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  CTarget *targets);
void brazo_2dof_a093840a_1_resetAsmStateVector(const void *mech, double
  *stateVector);
void brazo_2dof_a093840a_1_resetSimStateVector(const void *mech, double
  *stateVector);
void brazo_2dof_a093840a_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  double *stateVector,
  void *neDiagMgr);
void brazo_2dof_a093840a_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void brazo_2dof_a093840a_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void brazo_2dof_a093840a_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void brazo_2dof_a093840a_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void brazo_2dof_a093840a_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void brazo_2dof_a093840a_1_computeDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void brazo_2dof_a093840a_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void brazo_2dof_a093840a_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t brazo_2dof_a093840a_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t brazo_2dof_a093840a_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t brazo_2dof_a093840a_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
int brazo_2dof_a093840a_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
PmfMessageId brazo_2dof_a093840a_1_convertStateVector(
  const void *asmMech,
  ...
  void *neDiagMgr);
void brazo_2dof_a093840a_1_constructStateVector(
  const void *mech,
...
void brazo_2dof_a093840a_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
int brazo_2dof_a093840a_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
int brazo_2dof_a093840a_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId brazo_2dof_a093840a_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void brazo_2dof_a093840a_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  double *error);
void brazo_2dof_a093840a_1_resetModeVector(const void *mech, int *modeVector);
PmfMessageId brazo_2dof_a093840a_1_assemble(const double *u, double *udot,
  double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  brazo_2dof_a093840a_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  brazo_2dof_a093840a_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  brazo_2dof_a093840a_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  brazo_2dof_a093840a_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = brazo_2dof_a093840a_1_deriv(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = brazo_2dof_a093840a_1_output(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = brazo_2dof_a093840a_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 2,
    systemInput->mV.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    brazo_2dof_a093840a_1_computeZeroCrossings(
    systemInput->mU.mX,
    systemInput->mU.mX + 2,
    systemInput->mV.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL && smData->mDoCheckDynamics) {
    double result = 0.0;
    errorId = brazo_2dof_a093840a_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (modeChanged) {
    errorId = brazo_2dof_a093840a_1_onModeChanged(
      systemInput->mU.mX,
      systemInput->mU.mX + 2,
      systemInput->mV.mX + 2,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = brazo_2dof_a093840a_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 2,
      systemInput->mV.mX + 2,
  ...
  brazo_2dof_a093840a_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[4] = {
    ...
    { 0, 8, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 9, 0, false, 0, 2, "deg", false, true, +1.000000000000000000e+00, true,
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = brazo_2dof_a093840a_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = brazo_2dof_a093840a_1_ZCData;
    size_t i;
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mSetTargets = brazo_2dof_a093840a_1_setTargets;
  delegate->mResetStateVector = brazo_2dof_a093840a_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    brazo_2dof_a093840a_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState = brazo_2dof_a093840a_1_computeDiscreteState;
  delegate->mAdjustPosition = brazo_2dof_a093840a_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    brazo_2dof_a093840a_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputeDofBlendMatrix = brazo_2dof_a093840a_1_computeDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    brazo_2dof_a093840a_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = brazo_2dof_a093840a_1_propagateMotion;
  delegate->mComputeAssemblyError = brazo_2dof_a093840a_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    brazo_2dof_a093840a_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    brazo_2dof_a093840a_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    brazo_2dof_a093840a_1_isInKinematicSingularity;
  delegate->mConvertStateVector = brazo_2dof_a093840a_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector = brazo_2dof_a093840a_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    brazo_2dof_a093840a_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    brazo_2dof_a093840a_1_perturbFlexibleBodyState;
  ...
  delegate->mConstructStateVector = brazo_2dof_a093840a_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    brazo_2dof_a093840a_1_extractSolverStateVector;
  delegate->mIsPositionViolation = brazo_2dof_a093840a_1_isPositionViolation;
  delegate->mIsVelocityViolation = brazo_2dof_a093840a_1_isVelocityViolation;
  delegate->mProjectStateSim = brazo_2dof_a093840a_1_projectStateSim;
  delegate->mComputeConstraintError =
    brazo_2dof_a093840a_1_computeConstraintError;
  delegate->mResetModeVector = brazo_2dof_a093840a_1_resetModeVector;
  delegate->mMech = NULL;
}
...
void brazo_2dof_a093840a_1_NeDaePrivateData_create(NeDaePrivateData *smData)
{
