...
PmfMessageId brazo_2dof_a093840a_1_deriv(const RuntimeDerivedValuesBundle *rtdv,
  ...
  *neDiagMgr)
{
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      ...
      "'brazo_2dof/joint_B' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "sm:compiler:messages:simulationErrors:DegenerateMass",
      "'brazo_2dof/joint_A' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
