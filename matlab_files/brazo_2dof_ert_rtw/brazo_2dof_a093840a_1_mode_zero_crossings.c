...
const NeZCData *brazo_2dof_a093840a_1_ZCData = NULL;
PmfMessageId brazo_2dof_a093840a_1_computeAsmModeVector(const double *input,
...
PmfMessageId brazo_2dof_a093840a_1_computeSimModeVector(const double *input,
  const double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId brazo_2dof_a093840a_1_onModeChanged(const double *input, const
...
PmfMessageId brazo_2dof_a093840a_1_computeZeroCrossings(const double *input,
